...
| 选题推荐 | `scripts/suggest_topics.py` | ✅ 完成 | 基于笔记主题推荐可写选题 |
| 周报生成 | `scripts/weekly_report.py` | ✅ 完成 | 每周梳理入库内容 |
| 编译层 | `scripts/compile_topics.py` | ✅ 完成 | 多篇笔记合并成主题页（wiki/） |
| 往回织机制 | `scripts/weave_back.py` | ✅ 完成 | 新资料自动更新相关主题 |
